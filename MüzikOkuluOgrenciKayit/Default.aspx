<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MüzikOkuluOgrenciKayit.Default" %>
...
<head>
    ...
    <!-- /fonts -->
    <!-- css -->
    <link href="MusicSchool/css/style.css" rel="stylesheet" type='text/css' media="all" />
    <!-- /css -->
</head>
            ...
            <form action="#" method="post" class="agile_form" runat="server">
                ...
                <div class="section_class_agileits">
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem>Klarnet</asp:ListItem>
                ...
                <div class="submit-w3l">
                    <asp:Button runat="server" Text="Kaydet" OnClick="Unnamed1_Click"></asp:Button>
                </div>
            </form>
        </div>
        <div class="clear"></div>
